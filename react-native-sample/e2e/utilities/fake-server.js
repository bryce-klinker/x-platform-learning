...
app.get('/players/:id', (req, res) => {
  res.json(database.findById(database.players, req.params.id));
});

app.get('/competitions', (req, res) => res.json(database.competitions));
app.get('/competitions/:id', (req, res) =>
  res.json(database.findById(database.competitions, req.params.id)),
);

app.get('/clubs', (req, res) => res.json(database.clubs));
app.get('/clubs/:id', (req, res) =>
  res.json(database.findById(database.clubs, req.params.id)),
);
